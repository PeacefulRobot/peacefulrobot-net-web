<!DOCTYPE html><html><head><!-- link(rel="stylesheet" href="/main.css")--></head><body><h1>graceful-fs</h1><p>graceful-fs functions as a drop-in replacement for the fs module,
